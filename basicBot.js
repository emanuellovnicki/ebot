...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("ebot/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/emanuellovnicki/emanuell/master/basicBot.js",
        cmdLink: "lovneofficial.eu",
        chatLink: "ebot/lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "ebot/blacklists/ExampleNSFWlist.json",
                OP: "ebot/blacklists/ExampleOPlist.json"
            }
        },
        room: {
            users: [],
